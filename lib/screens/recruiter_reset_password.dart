...
import 'recruiter_password_success.dart';

class RResetPassword extends StatefulWidget {
  @override
  _RResetPasswordState createState() => _RResetPasswordState();
}

class _RResetPasswordState extends State<RResetPassword> {
