...
import 'recruiter_login.dart';

class RecruiterCharges extends StatefulWidget {
  @override
  _RecruiterChargesState createState() => _RecruiterChargesState();
}

class _RecruiterChargesState extends State<RecruiterCharges> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await Provider.of<Auth>(context, listen: false).recruiterCharges(val);
      print("here");
      openCheckout();
  ...
  void handlerPaymentSuccess(PaymentSuccessResponse response) {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => RecruiterHomePage()));
